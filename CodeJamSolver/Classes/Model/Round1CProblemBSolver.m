...
//  Also rewrite method +[Computer specificProblemSolverClass] to return [Round1CProblemBSolver class].
//
//  *** Problem (B)
//

#import "Round1CProblemBSolver.h"


@implementation Round1CProblemBSolver

NSString *kDefaultOutput1C_B = @"DEFAULT";
