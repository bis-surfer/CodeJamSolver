...
//  and replace file of the same name ("Round1CProblemASolver.m") with the present file.
//  Also rewrite method +[Computer specificProblemSolverClass] to return [Round1CProblemASolver class].
//
//  *** Problem (A)
//

#import "Round1CProblemASolver.h"


@implementation Round1CProblemASolver

NSString *kDefaultOutput1C_A = @"DEFAULT";
